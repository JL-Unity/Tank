...
public class MapCreation : MonoBehaviour {
    ...
    //用来装饰初始化地图所需物体的数组。
    //0.老家 1.墙 2.障碍 3.出生效果 4.河流 5.草 6.空气墙7.玩家1 8.玩家2
    ...
    private void InitMap(int playerNum)
    {
        ...
        if (playerNum == 1)
        {
             ...
             Instantiate(item[7], new Vector3(-2, -8, 0), Quaternion.identity);
        }
        if(playerNum == 2)
        { 
             ...
             Instantiate(item[8], new Vector3(2, -8, 0), Quaternion.identity);
        }
